...
//
//go:embed policy.json workspace.json agents.md story.md ship-pr-body.md scout-report.md epic/DESIGN.md services/example.sh arena/adversary.md arena/reviewer.md arena/domain.md arena/adversary-round2.md arena/reviewer-round2.md arena/domain-round2.md arena/synthesis.md
var FS embed.FS
